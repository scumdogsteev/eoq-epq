...
* For the above scenario, the EOQ is `r eoqty`
...
* For the above scenario, the EPQ is `r round(epqty, 1)`
* Each production run should be `r ceiling(epqty)` in this case (assuming
